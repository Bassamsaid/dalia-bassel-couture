...
try { db.exec("ALTER TABLE about ADD COLUMN img_pos TEXT"); } catch (e) { /* column exists */ }
try { db.exec("ALTER TABLE about ADD COLUMN img_zoom TEXT"); } catch (e) { /* column exists */ }
try { db.exec("ALTER TABLE about ADD COLUMN img_shape TEXT"); } catch (e) { /* column exists */ }
...
db.exec(`CREATE TABLE IF NOT EXISTS dalia_media (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
try { db.exec('ALTER TABLE users ADD COLUMN login_count INTEGER NOT NULL DEFAULT 0'); } catch (e) { /* column exists */ }
try { db.exec('ALTER TABLE users ADD COLUMN first_login TEXT'); } catch (e) { /* column exists */ }
try { db.exec('ALTER TABLE users ADD COLUMN last_login TEXT'); } catch (e) { /* column exists */ }
